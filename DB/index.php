...
<body style="position:relative">
    ...
    <section style="transform: translateY(-8rem);">
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-6 wow zoomIn" data-wow-duration="1s" data-wow-delay="1.2s">
                    <div class="shadow rounded text-white  text-center py-3 m-2 bg-danger">
                        <h6> MONDAY TO SATURDAY </h6>
                        <h3 class="mt-2">10.00-21.00</h3>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 wow zoomIn" data-wow-duration="1s" data-wow-delay="0.3s">
